...
```{r echo=FALSE}
office_web_viewer( url = paste0( "https://davidgohel.github.io/officer/articles/", "assets/pptx/first_example.pptx" ) )
```
...
print(my_pres, target = "assets/pptx/ph_with_text.pptx") %>% 
  invisible()
```

```{r echo=FALSE}
office_web_viewer( url = paste0( "https://davidgohel.github.io/officer/articles/", "assets/pptx/ph_with_text.pptx" ) )
```
...
print(my_pres, target = "assets/pptx/ph_with_img.pptx") %>% 
  invisible()
```

```{r echo=FALSE}
office_web_viewer( url = paste0( "https://davidgohel.github.io/officer/articles/", "assets/pptx/ph_with_img.pptx" ) )
```
...
In the following example, shape corresponding to `type "body"` and `id "3"` 
...
```{r echo=FALSE}
office_web_viewer( url = paste0( "https://davidgohel.github.io/officer/articles/", "assets/pptx/ph_add_text_1.pptx" ) )
```
...
```{r echo=FALSE}
office_web_viewer( url = paste0( "https://davidgohel.github.io/officer/articles/", "assets/pptx/ph_add_text_2.pptx" ) )
```
