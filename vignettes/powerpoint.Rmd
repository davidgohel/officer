...
Arguments `left` and `top` are specifying the top left coordinate of the new shape and arguments 
`width` and `height` are specifying the dimensions of the new shape.
