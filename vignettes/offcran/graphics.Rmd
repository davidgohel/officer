...
```{r echo=FALSE}
office_doc_link( url = paste0( "https://davidgohel.github.io/officer/articles/", "assets/graphics/demo_mschart_01.docx" ) )
```
...
```{r echo=FALSE}
office_doc_link( url = paste0( "https://davidgohel.github.io/officer/articles/", "assets/graphics/demo_mschart_01.pptx" ) )
```
