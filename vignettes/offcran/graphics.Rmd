...
Package `rvg` is providing editable vector graphics that can be used with `officer`. Function `ph_with_vg` can be used to generate (from R plot commands) a nice editable graphic within PowerPoint.
