...
```{r echo=FALSE}
office_doc_link(url = paste0("https://davidgohel.github.io/officer/articles/offcran/", "assets/docx/first_example.docx"))
```
...
office_doc_link( url = paste0( "https://davidgohel.github.io/officer/articles/offcran/", "assets/docx/body_add_demo.docx" ) )
```
...
```{r echo=FALSE}
office_doc_link( url = paste0( "https://davidgohel.github.io/officer/articles/offcran/", "assets/docx/slip_in_demo.docx" ) )
```
...
Note that usage of SEQ field require usage of Word to edit the content and 
replace the code by its value.
...
```{r echo=FALSE}
office_doc_link( url = paste0( "https://davidgohel.github.io/officer/articles/offcran/", "assets/docx/init_doc.docx" ) )
```
...
```{r echo=FALSE}
office_doc_link( url = paste0( "https://davidgohel.github.io/officer/articles/offcran/", "assets/docx/cursor.docx" ) )
```
...
```{r echo=FALSE}
office_doc_link( url = paste0( "https://davidgohel.github.io/officer/articles/offcran/", "assets/docx/ipsum_doc.docx" ) )
```
...
```{r echo=FALSE}
office_doc_link( url = paste0( "https://davidgohel.github.io/officer/articles/offcran/", "assets/docx/replace_doc.docx" ) )
```
...
```{r echo=FALSE}
office_doc_link( url = paste0( "https://davidgohel.github.io/officer/articles/offcran/", "assets/docx/landscape_section.docx" ) )
```
...
```{r echo=FALSE}
office_doc_link( url = paste0( "https://davidgohel.github.io/officer/articles/offcran/", "assets/docx/columns_section.docx" ) )
```
...
```{r echo=FALSE}
office_doc_link( url = paste0( "https://davidgohel.github.io/officer/articles/offcran/", "assets/docx/columns_landscape_section.docx" ) )
```
...
```{r echo=FALSE}
office_doc_link( url = paste0( "https://davidgohel.github.io/officer/articles/offcran/", "assets/docx/section.docx" ) )
```
...
```{r echo=FALSE}
office_doc_link( url = paste0( "https://davidgohel.github.io/officer/articles/offcran/", "assets/docx/toc_and_captions.docx" ) )
```
