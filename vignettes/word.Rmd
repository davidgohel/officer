...
```{r echo=FALSE}
office_web_viewer( url = paste0( "https://davidgohel.github.io/officer/articles/", "assets/docx/first_example.docx" ) )
```
...
```{r echo=FALSE}
office_web_viewer( url = paste0( "https://davidgohel.github.io/officer/articles/", "assets/docx/init_doc.docx" ) )
```
...
```{r echo=FALSE}
office_web_viewer( url = paste0( "https://davidgohel.github.io/officer/articles/", "assets/docx/cursor.docx" ) )
```
...
```{r echo=FALSE}
office_web_viewer( url = paste0( "https://davidgohel.github.io/officer/articles/", "assets/docx/slip_in_demo.docx" ) )
```
...
```{r echo=FALSE}
office_web_viewer( url = paste0( "https://davidgohel.github.io/officer/articles/", "assets/docx/ipsum_doc.docx" ) )
```
...
```{r echo=FALSE}
office_web_viewer( url = paste0( "https://davidgohel.github.io/officer/articles/", "assets/docx/section.docx" ) )
```
