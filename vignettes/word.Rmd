...
* Table templates are also defined in the initial document and can be used with `body_add_table`. For advanced tabular formatting, use package `flextable` instead, it has a function `body_add_flextable()` that can be used with `officer`.
