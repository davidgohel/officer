...
For illustration purposes, we will generate a document that will be used as initial document later when showing how to use `body_remove`.
...
Functions `body_add_*` let you replace content in a Word document. 
