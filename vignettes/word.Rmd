...
`body_replace_at()` replaces text at a bookmark:
...
Sections can be added to a document. This is possible by using the function 
`body_end_section()`. The default section can be modified with the function 
...
In the previous example, the first two paragraphs will be in a 2 column section 
and the third will be in a default section.
