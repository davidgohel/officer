...
Wrap an
[`fpar()`](https://davidgohel.github.io/officer/reference/fpar.md) with
a hierarchy level for use inside
...
- x:
  ...
  an [`fpar()`](https://davidgohel.github.io/officer/reference/fpar.md)
  object or a character string (automatically converted to
  [`fpar()`](https://davidgohel.github.io/officer/reference/fpar.md))

- level:

  hierarchy level, integer starting at 1
