...
- [`docx_dim()`](https://davidgohel.github.io/officer/reference/docx_dim.md)
  : 'Word' page layout
- [`docx_show_chunk()`](https://davidgohel.github.io/officer/reference/docx_show_chunk.md)
...
- [`cursor_begin()`](https://davidgohel.github.io/officer/reference/cursor.md)
  ...
  [`cursor_backward()`](https://davidgohel.github.io/officer/reference/cursor.md)
...
- [`body_bookmark()`](https://davidgohel.github.io/officer/reference/body_bookmark.md)
...
- [`prop_section()`](https://davidgohel.github.io/officer/reference/prop_section.md)
  : Section properties
- [`page_mar()`](https://davidgohel.github.io/officer/reference/page_mar.md)
  : Page margins object
...
- [`body_replace_text_at_bkm()`](https://davidgohel.github.io/officer/reference/body_replace_text_at_bkm.md)
  [`body_replace_img_at_bkm()`](https://davidgohel.github.io/officer/reference/body_replace_text_at_bkm.md)
  [`headers_replace_text_at_bkm()`](https://davidgohel.github.io/officer/reference/body_replace_text_at_bkm.md)
  [`headers_replace_img_at_bkm()`](https://davidgohel.github.io/officer/reference/body_replace_text_at_bkm.md)
  [`footers_replace_text_at_bkm()`](https://davidgohel.github.io/officer/reference/body_replace_text_at_bkm.md)
  [`footers_replace_img_at_bkm()`](https://davidgohel.github.io/officer/reference/body_replace_text_at_bkm.md)
...
- [`body_replace_all_text()`](https://davidgohel.github.io/officer/reference/body_replace_all_text.md)
  [`headers_replace_all_text()`](https://davidgohel.github.io/officer/reference/body_replace_all_text.md)
  [`footers_replace_all_text()`](https://davidgohel.github.io/officer/reference/body_replace_all_text.md)
  : Replace text anywhere in the document

## Remove content from Word documents

- [`body_remove()`](https://davidgohel.github.io/officer/reference/body_remove.md)
...
- [`ph_with()`](https://davidgohel.github.io/officer/reference/ph_with.md)
  [`ph_with.character()`](https://davidgohel.github.io/officer/reference/ph_with.md)
  [`ph_with.numeric()`](https://davidgohel.github.io/officer/reference/ph_with.md)
  [`ph_with.factor()`](https://davidgohel.github.io/officer/reference/ph_with.md)
  [`ph_with.logical()`](https://davidgohel.github.io/officer/reference/ph_with.md)
  [`ph_with.Date()`](https://davidgohel.github.io/officer/reference/ph_with.md)
  [`ph_with.block_list()`](https://davidgohel.github.io/officer/reference/ph_with.md)
  [`ph_with.unordered_list()`](https://davidgohel.github.io/officer/reference/ph_with.md)
  [`ph_with.block_list_items()`](https://davidgohel.github.io/officer/reference/ph_with.md)
  [`ph_with.data.frame()`](https://davidgohel.github.io/officer/reference/ph_with.md)
  [`ph_with.gg()`](https://davidgohel.github.io/officer/reference/ph_with.md)
  [`ph_with.plot_instr()`](https://davidgohel.github.io/officer/reference/ph_with.md)
  [`ph_with.external_img()`](https://davidgohel.github.io/officer/reference/ph_with.md)
  [`ph_with.fpar()`](https://davidgohel.github.io/officer/reference/ph_with.md)
  [`ph_with.empty_content()`](https://davidgohel.github.io/officer/reference/ph_with.md)
  [`ph_with.xml_document()`](https://davidgohel.github.io/officer/reference/ph_with.md)
...
- [`sp_lineend()`](https://davidgohel.github.io/officer/reference/sp_lineend.md)
  ...
  [`update(`*`<sp_lineend>`*`)`](https://davidgohel.github.io/officer/reference/sp_lineend.md)
  : Line end properties
...
- [`media_extract()`](https://davidgohel.github.io/officer/reference/media_extract.md)
  : Extract media from a document object
- [`as.matrix(`*`<rpptx>`*`)`](https://davidgohel.github.io/officer/reference/as.matrix.rpptx.md)
  : PowerPoint table to matrix

## Content formatting

Define formatted paragraphs or parts of paragraphs, such as text,
calculated Word fields, images, or sets of paragraphs. The four
sub-sections below go from the atomic formatting specs (properties) up
to the composite blocks.

### Properties

Atomic formatting specs consumed by runs, paragraphs and table cells
(font, colour, borders, alignment, tab stops, etc.).
...
- [`fp_text()`](https://davidgohel.github.io/officer/reference/fp_text.md)
  ...
  [`format(`*`<fp_text>`*`)`](https://davidgohel.github.io/officer/reference/fp_text.md)
  [`print(`*`<fp_text>`*`)`](https://davidgohel.github.io/officer/reference/fp_text.md)
  [`update(`*`<fp_text>`*`)`](https://davidgohel.github.io/officer/reference/fp_text.md)
...
- [`fp_par()`](https://davidgohel.github.io/officer/reference/fp_par.md)
  ...
  [`print(`*`<fp_par>`*`)`](https://davidgohel.github.io/officer/reference/fp_par.md)
  [`update(`*`<fp_par>`*`)`](https://davidgohel.github.io/officer/reference/fp_par.md)
  : Paragraph formatting properties
- [`fp_border()`](https://davidgohel.github.io/officer/reference/fp_border.md)
  [`update(`*`<fp_border>`*`)`](https://davidgohel.github.io/officer/reference/fp_border.md)
  : Border properties object
- [`fp_cell()`](https://davidgohel.github.io/officer/reference/fp_cell.md)
  [`format(`*`<fp_cell>`*`)`](https://davidgohel.github.io/officer/reference/fp_cell.md)
  [`print(`*`<fp_cell>`*`)`](https://davidgohel.github.io/officer/reference/fp_cell.md)
  [`update(`*`<fp_cell>`*`)`](https://davidgohel.github.io/officer/reference/fp_cell.md)
...
A run is a piece of text inside a paragraph with homogeneous formatting.
Runs include plain formatted text, line breaks, hyperlinks, bookmarks,
footnotes and Word fields.
...
A block is a paragraph-level element (paragraph, caption, table, list,
section, pour, table of contents) that can be added to the body of a
Word document or to a PowerPoint placeholder.

- [`fpar()`](https://davidgohel.github.io/officer/reference/fpar.md)
  [`update(`*`<fpar>`*`)`](https://davidgohel.github.io/officer/reference/fpar.md)
  : Formatted paragraph
...
Raster images embedded either inline in a paragraph or anchored as a
floating element.
...
- [`read_xlsx()`](https://davidgohel.github.io/officer/reference/read_xlsx.md)
  [`length(`*`<rxlsx>`*`)`](https://davidgohel.github.io/officer/reference/read_xlsx.md)
  [`print(`*`<rxlsx>`*`)`](https://davidgohel.github.io/officer/reference/read_xlsx.md)
  : Create an 'Excel' document object
- [`add_sheet()`](https://davidgohel.github.io/officer/reference/add_sheet.md)
  : Add a sheet
- [`sheet_names()`](https://davidgohel.github.io/officer/reference/sheet_names.md)
...
- [`officer-package`](https://davidgohel.github.io/officer/reference/officer.md)
  [`officer`](https://davidgohel.github.io/officer/reference/officer.md)
  : Manipulate Microsoft Word and PowerPoint Documents with 'officer'
- [`open_file()`](https://davidgohel.github.io/officer/reference/open_file.md)
  : Opens a file locally
- [`shortcuts`](https://davidgohel.github.io/officer/reference/shortcuts.md)
