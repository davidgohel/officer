...
Function `docx_summary` read and import content of a Word document into 
a data.frame object. The function handles paragraphs, tables and section breaks. 
...
Function `pptx_summary` read and import content of a PowerPoint document into 
a data.frame object. The function handles paragraphs, tables and images. 
