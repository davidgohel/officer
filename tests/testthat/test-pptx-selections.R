...
test_that("get shape id", {
  ...
  expect_equal(get_shape_id(doc, type = "body")[1], "2")
  expect_equal(get_shape_id(doc, ph_label = "Content Placeholder 2")[1], "2")
  expect_error(get_shape_id(doc, type = "body", id = 4) )
})
