...
run_as_tibble <- function(node, styles) {
  ...
  run_data <- data.frame(
    ...
    underline = val_child(node, "w:rPr/w:u", default = NA_character_),
    sz = val_child_int(node, "w:rPr/w:sz", default = NA_integer_),
    szCs = val_child_int(node, "w:rPr/w:szCs", default = NA_integer_),
    color = val_child(node, "w:rPr/w:color", default = NA_character_),
    shading = val_child(node, "w:rPr/w:shd", default = NA_character_),
    shading_color = val_child(node, "w:rPr/w:shd", attr = "color", default = "auto"),
    shading_fill = val_child(node, "w:rPr/w:shd", attr = "fill", default = "auto"),
    style_name = style_name,
    stringsAsFactors = FALSE
  )
